module signature_verification

go 1.25.3

replace github.com/jmgilman/go/oci => ../..

replace github.com/jmgilman/go/oci/signature => ../../signature

require (
	github.com/jmgilman/go/oci v0.1.0
	github.com/jmgilman/go/oci/signature v0.0.0-00010101000000-000000000000
)
